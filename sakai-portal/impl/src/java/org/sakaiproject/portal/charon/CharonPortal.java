/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/portal/trunk/impl/src/java/org/sakaiproject/portal/charon/CharonPortal.java $
 * $Id$
 ***********************************************************************************
 *
...
import org.sakaiproject.portal.charon.portlet.PortletTool;
...
public class CharonPortal extends HttpServlet
{
    ...
    protected void includeLogo(PrintWriter out, HttpServletRequest req,
                               Session session, String siteId) throws IOException
    {
        String skin = SiteService.getSiteSkin(siteId);
        if (skin == null)
    ...
    protected void includeLogin(PrintWriter out, HttpServletRequest req,
                                Session session)
    {
        ...
        else
        {
            ...
            out
                    .println("<label for=\"eid\">"
                            + eidWording
                            + "</label><input name=\"eid\" id=\"eid\" type=\"text\" />");
            out
                    .println("<label for=\"pw\">"
                            + pwWording
            ...
            throws IOException
    {
        ...
        for (Iterator i = tools.iterator(); i.hasNext();)
        {
            ...
            // invoke the tool
            includeTool(out, req, placement, toolContextPath);
        }
        out.println("</div>");
    ...
    protected void includeTabs(PrintWriter out, HttpServletRequest req,
            ...
            throws IOException
    {
        ...
        for (Iterator i = mySites.iterator(); i.hasNext();)
        {
            ...
            {
                out
                        .println("							<li class=\"selectedTab\"><a href=\"#\"><span>"
    ...
    protected void includeTool(PrintWriter out, HttpServletRequest req,
                               ToolConfiguration placement, String toolContextPath) throws IOException
    {
        ...
        if(placement.getTool() instanceof PortletTool) {
            includePortlet(out, placement, toolContextPath);
        }
        includeRawTool(out, placement, titleString, toolUrl);
        out.println("</div></div>");
    }

    private void includePortlet(PrintWriter out, ToolConfiguration placement, String toolContextPath) {

    }

    private void includeRawTool(PrintWriter out, ToolConfiguration placement, String titleString, String toolUrl) {
        out.println("<iframe");
        out.println("	name=\""
                                        ...
                                        String skin, boolean top) throws IOException
    {
        ...
        out
                .println("    <meta http-equiv=\"Content-Style-Type\" content=\"text/css\" />"
                        + "    <title>"
