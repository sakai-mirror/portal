...
public class SiteHandler extends WorksiteHandler
{
			...
			Session session, String siteId) throws IOException
	{
		if (rcontext.uses(INCLUDE_LOGO))
		{
			...
			String bannerAlt = ServerConfigurationService.getString("banner.alt", "Banner");
