/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/branches/sakai_2-1-2/portal/portal-component/src/java/org/sakaiproject/portal/charon/CharonPortal.java $
 * $Id: CharonPortal.java 6474 2006-03-06 11:45:24 -0500 (Mon, 06 Mar 2006) lance@indiana.edu $
 **********************************************************************************
 *
...
//		}
			...
			String toolContextPath, String toolPathInfo) throws ToolException, IOException
	{
		...
		org.sakaiproject.util.Placement placement = new org.sakaiproject.util.Placement(siteId + "-presence", tool, null, siteId,
				null);
			...
			String toolPathInfo) throws ToolException, IOException
	{
		...
		org.sakaiproject.util.Placement placement = new org.sakaiproject.util.Placement("help", tool, null, null, null);
...
// gsilver - jump to links
	...
	protected void includeLogin(PrintWriter out, HttpServletRequest req, Session session)
	{
		...
		else
		{
			...
			out.println("<form method=\"post\" action=\"/portal/xlogin\" enctype=\"application/x-www-form-urlencoded\" target=\"_parent\">");
			...
			boolean addLogout) throws IOException
	{
		...
		List mySites = SiteService.getSites(org.sakaiproject.service.legacy.site.SiteService.SelectionType.ACCESS, null, null,
				null, org.sakaiproject.service.legacy.site.SiteService.SortType.TITLE_ASC, null);
...
// gsilver - target for "jump to tabs" link and header
	...
	protected void includeTool(PrintWriter out, HttpServletRequest req, ToolConfiguration placement) throws IOException
	{
		...
		// find the tool registered for this
		ActiveTool tool = ActiveToolManager.getActiveTool(placement.getTool().getId());
		if (tool == null)
		{
